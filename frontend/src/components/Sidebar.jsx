...
const Sidebar = () => {
    ...
    return (
        <div
            className={`bg-[#818582]/10 h-full rounded-r-xl overflow-y-scroll
    text-white ${selectedUser ? "max-md:hidden" : ""}`}
        ...
        border border-gray-600 text-gray-100 hidden group-hover:block "
                ...
                <div
                    className="bg-[#282142] rounded-l-full flex items-center
        gap-2 px-4 py-3 mt-5 "
                >
                ...
                {filteredUsers.map((user, index) => (
                    ...
                    cursor-pointer max-sm:text-sm ${selectedUser?._id === user._id && 'bg-[#282142]/50'}`}>
                        <img
                            ...
                            alt=""
                            className="
                        w-[35px] aspect-[1/1] rounded-full "
                        />
                        <div className="flex flex-col leading-5 ">
                            ...
                            : 
                                <span className="text-neutral-400-400 text-xs">Ofline</span>
                            }
                        </div>
                        {unseenMessages[user._id] > 0 && 
                            <p
                                className="
                            absolute top-4 right-4 text-xs h-5 w-5
                            flex justify-center items-center rounded-l-full bg-violet-500/50"
                            >
